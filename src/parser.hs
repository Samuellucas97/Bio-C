...
eval_un (Translate p1) [(Lexer.Rna p y)] = (Lexer.Protein p ("p:" ++ (traducao (tail(tail(y))))   ))
eval_un (Translate p1) [(Lexer.Dna p y)] = (Lexer.Protein p ("p:" ++ (traducao (transcricao (tail(tail(y)))))   ))
